...
class Logistical
{
    ...
    public function __construct()
    {
        ...
        $this->customer = '251A55F77C7DCCC0B28D5E2C7992966A';
        $this->key = 'lXvcdCuE2193';

    }

    public static function expresses($info){
     ...
     * @param num   订单号
     */
    public function getCom($num){

        $url = 'http://www.kuaidi100.com/autonumber/auto?num='.$num.'&key='.$this->key;
        $curl = curl_init();
     ...
     * @param num   订单号
     */
    public function simulatorCurl($com,$num){
