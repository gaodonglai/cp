<?php
/**
 * mailer - PHP email transport unit tests
...
/**
 * mailer - PHP email transport unit test class
...
<html>
    ...
    <body>
        <h1>mailer does HTML!</h1>
        <p>This is a <strong>test message</strong> written in HTML.<br>
        Go to <a href="https://github.com/mailer/mailer/">https://github.com/mailer/mailer/</a>
        for new versions of mailer.</p>
        <p>Thank you!</p>
    </body>
</html>
EOT;
    ...
    public function testIcal()
    {
        ...
        $ICS = new EasyPeasyICS("mailer test calendar");
        $ICS->addEvent(
            strtotime('tomorrow 10:00 Europe/Paris'),
            strtotime('tomorrow 11:00 Europe/Paris'),
            'mailer iCal test',
            'A test of mailer iCal support',
            'https://github.com/mailer/mailer'
        );
     ...
     *    http://www.cybsec.com/vuln/mailer-DOS.pdf
     */
    ...
    public function testSigning()
    {
        ...
        $dn = array(
            ...
            'organizationalUnitName' => 'mailer',
            'commonName' => 'mailer Test',
