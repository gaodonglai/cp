...
<?php
/* This is a sample callback function for mailer Lite.
 * This callback function will echo the results of mailer processing.
 */
...
try {
    ...
    $mail->Subject = 'mailer Test Subject';
    ...
    echo $e->errorMessage(); //Pretty error messages from mailer
} catch (Exception $e) {
